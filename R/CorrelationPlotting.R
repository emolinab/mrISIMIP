...
source("/p/projects/landuse/users/mbacca/Paper2/mrISIMIP/R/readGLOBIOM2.R")
...
GLOBIOM_c<-setNames(readGLOBIOM2(ssp="1",SPA="1",RCP="2p6",gcm="GFDL",type="Cropland",year=2010),"crop")
GLOBIOM_g<-setNames(readGLOBIOM2(ssp="1",SPA="1",RCP="2p6",gcm="GFDL",type="Grassland",year=2010),"past")
GLOBIOM_f<-setNames(readGLOBIOM2(ssp="1",SPA="1",RCP="2p6",gcm="GFDL",type="Forest",year=2010),"forest")
GLOBIOM_o<-setNames(readGLOBIOM2(ssp="1",SPA="1",RCP="2p6",gcm="GFDL",type="Other",year=2010),"other")
GLOBIOM_u<-setNames(readGLOBIOM2(ssp="1",SPA="1",RCP="2p6",gcm="GFDL",type="Urban",year=2010),"urban")
